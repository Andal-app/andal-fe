    ...
    <BasicLayout>
      <div className="relative w-full h-full bg-map flex justify-center items-center">
        <div className="z-10 flex flex-col items-center gap-8 text-center -mt-36 lg:mt-0">
          ...
          <p className="text-b-md lg:text-b-lg text-neutral-900 max-w-[85%] lg:max-w-[420px]">
        ...
        <Link className="z-30 absolute right-8 bottom-16 bg-white hover:bg-violet-50 w-12 h-12 rounded-full flex justify-center items-center">
